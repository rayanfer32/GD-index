var authConfig = {
  ...
  main_color: 'amber', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime yellow | amber orange | deep-orange | brown | greyblue-grey
  accent_color: 'amber', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange
  dark_theme: true, // true for dark theme
  // client_id & client_secret - PLEASE USE YOUR OWN!
  client_id: '1046394013504288-s0l64pps.googleusercontent.com',
  client_secret: 'FEoc2bR9SJvup5VOI0',
  refresh_token: '1//09SV0OYqMfHhUCgrUP2mBJRXKqa2n_P5s', // Refresh token
...
<head>
  ...
  <script src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/Rayanfer32/GD-index/dist/app.js"></script>
